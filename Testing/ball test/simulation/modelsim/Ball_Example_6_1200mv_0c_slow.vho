...
SIGNAL \inst2|ball_on~3_combout\ : std_logic;
SIGNAL \inst2|ball_on~6_combout\ : std_logic;
SIGNAL \inst2|ball_on~7_combout\ : std_logic;
SIGNAL \inst2|ball_on~8_combout\ : std_logic;
SIGNAL \inst2|ball_on~9_combout\ : std_logic;
SIGNAL \inst2|ball_on~10_combout\ : std_logic;
...
SIGNAL \inst2|ball_on~4_combout\ : std_logic;
SIGNAL \inst2|ball_on~5_combout\ : std_logic;
...
SIGNAL \inst2|ball_on~11_combout\ : std_logic;
...
-- Equation(s):
-- \inst2|Add2~0_combout\ = (\inst1|pixel_row\(3) & (\inst1|pixel_row\(4) $ (VCC))) # (!\inst1|pixel_row\(3) & (\inst1|pixel_row\(4) & VCC))
-- \inst2|Add2~1\ = CARRY((\inst1|pixel_row\(3) & \inst1|pixel_row\(4)))
...
-- Equation(s):
-- \inst2|ball_on~0_combout\ = (\inst1|pixel_column\(3)) # ((\inst1|pixel_column\(1) & (\inst1|pixel_column\(0) & \inst1|pixel_column\(2))))
...
-- Equation(s):
-- \inst2|ball_on~1_combout\ = (\inst1|pixel_column\(6) & ((\inst1|pixel_column\(5)) # ((\inst2|ball_on~0_combout\ & \inst1|pixel_column\(4)))))
...
-- Equation(s):
-- \inst2|ball_on~2_combout\ = (\inst1|pixel_column\(9) & ((\inst2|ball_on~1_combout\) # ((\inst1|pixel_column\(8)) # (\inst1|pixel_column\(7)))))
...
\inst2|ball_on~3\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~3_combout\ = (\inst1|pixel_row\(3)) # ((\inst1|pixel_row\(1) & (\inst1|pixel_row\(0) & \inst1|pixel_row\(2))))
...
PORT MAP (
	...
	combout => \inst2|ball_on~3_combout\);

-- Location: LCCOMB_X22_Y10_N8
\inst2|ball_on~6\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~6_combout\ = (\inst1|pixel_row\(3)) # (((!\inst1|pixel_row\(2)) # (!\inst1|pixel_row\(1))) # (!\inst2|Add2~0_combout\))
...
PORT MAP (
	...
	datad => \inst1|pixel_row\(2),
	combout => \inst2|ball_on~6_combout\);

-- Location: LCCOMB_X22_Y10_N2
\inst2|ball_on~7\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~7_combout\ = ((!\inst2|Add2~2_combout\ & \inst2|ball_on~6_combout\)) # (!\inst2|Add2~4_combout\)
...
PORT MAP (
	...
	datac => \inst2|ball_on~6_combout\,
	datad => \inst2|Add2~4_combout\,
	combout => \inst2|ball_on~7_combout\);

-- Location: LCCOMB_X22_Y10_N4
\inst2|ball_on~8\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~8_combout\ = (!\inst2|Add2~10_combout\ & (((!\inst2|Add2~6_combout\ & \inst2|ball_on~7_combout\)) # (!\inst2|Add2~8_combout\)))
...
PORT MAP (
	...
	datad => \inst2|ball_on~7_combout\,
	combout => \inst2|ball_on~8_combout\);

-- Location: LCCOMB_X21_Y10_N2
\inst2|ball_on~9\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~9_combout\ = (\inst1|pixel_column\(3)) # ((!\inst1|pixel_column\(1)) # (!\inst1|pixel_column\(2)))
...
PORT MAP (
	...
	combout => \inst2|ball_on~9_combout\);

-- Location: LCCOMB_X21_Y10_N28
\inst2|ball_on~10\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~10_combout\ = ((!\inst2|Add0~2_combout\ & (!\inst2|Add0~0_combout\ & \inst2|ball_on~9_combout\))) # (!\inst2|Add0~4_combout\)
...
PORT MAP (
	...
	datad => \inst2|ball_on~9_combout\,
	combout => \inst2|ball_on~10_combout\);
...
-- Equation(s):
-- \inst1|v_count[2]~9_combout\ = (\inst1|v_count[9]~0_combout\ & (\inst1|Add1~4_combout\ & ((\inst1|process_0~13_combout\)))) # (!\inst1|v_count[9]~0_combout\ & (((\inst1|v_count\(2)))))
...
-- Equation(s):
-- \inst1|Equal0~1_combout\ = (!\inst1|h_count\(7) & (\inst1|h_count\(8) & (\inst1|h_count\(2) & !\inst1|h_count\(5))))
...
-- Equation(s):
-- \inst1|Equal0~2_combout\ = (\inst1|Equal0~0_combout\ & (\inst1|Equal0~1_combout\ & (!\inst1|h_count\(6) & \inst1|h_count\(9))))
...
-- Equation(s):
-- \inst1|v_count~10_combout\ = (\inst1|Add1~2_combout\ & ((\inst1|process_0~8_combout\) # ((\inst1|process_0~12_combout\) # (\inst1|process_0~11_combout\))))
...
-- Equation(s):
-- \inst1|v_count[9]~0_combout\ = ((!\inst1|process_0~8_combout\ & (!\inst1|process_0~12_combout\ & !\inst1|process_0~11_combout\))) # (!\inst1|Equal1~1_combout\)
...
-- Equation(s):
-- \inst1|v_count[4]~6_combout\ = (\inst1|v_count[9]~0_combout\ & (\inst1|process_0~13_combout\ & ((\inst1|Add1~8_combout\)))) # (!\inst1|v_count[9]~0_combout\ & (((\inst1|v_count\(4)))))
...
\inst2|ball_on~4\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~4_combout\ = (\inst1|pixel_row\(6) & (\inst1|pixel_row\(5) & ((\inst2|ball_on~3_combout\) # (\inst1|pixel_row\(4)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ball_on~3_combout\,
	datab => \inst1|pixel_row\(6),
	datac => \inst1|pixel_row\(4),
	datad => \inst1|pixel_row\(5),
	combout => \inst2|ball_on~4_combout\);
...
\inst2|ball_on~5\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~5_combout\ = (\inst2|ball_on~2_combout\) # ((\inst1|pixel_row\(8) & ((\inst1|pixel_row\(7)) # (\inst2|ball_on~4_combout\))))
...
PORT MAP (
	...
	datab => \inst1|pixel_row\(7),
	datac => \inst2|ball_on~4_combout\,
	datad => \inst1|pixel_row\(8),
	combout => \inst2|ball_on~5_combout\);
...
-- Equation(s):
-- \inst2|Add0~10_combout\ = \inst2|Add0~9\ $ (\inst1|pixel_column\(9))
...
\inst2|ball_on~11\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst2|ball_on~11_combout\ = ((\inst2|ball_on~10_combout\ & (!\inst2|Add0~8_combout\ & !\inst2|Add0~6_combout\))) # (!\inst2|Add0~10_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ball_on~10_combout\,
	datab => \inst2|Add0~10_combout\,
	datac => \inst2|Add0~8_combout\,
	datad => \inst2|Add0~6_combout\,
	combout => \inst2|ball_on~11_combout\);

-- Location: LCCOMB_X21_Y10_N10
\inst1|green_out~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst1|green_out~0_combout\ = (\inst1|video_on~combout\ & ((\inst2|ball_on~8_combout\) # ((\inst2|ball_on~5_combout\) # (\inst2|ball_on~11_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst2|ball_on~8_combout\,
	datab => \inst2|ball_on~5_combout\,
	datac => \inst2|ball_on~11_combout\,
	datad => \inst1|video_on~combout\,
	combout => \inst1|green_out~0_combout\);

-- Location: LCCOMB_X21_Y10_N8
\inst1|green_out~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst1|green_out~feeder_combout\ = \inst1|green_out~0_combout\
...
-- Equation(s):
-- \inst1|v_count~8_combout\ = (\inst1|Add1~0_combout\ & ((\inst1|process_0~8_combout\) # ((\inst1|process_0~12_combout\) # (\inst1|process_0~11_combout\))))
...
-- Equation(s):
-- \inst1|v_count[3]~7_combout\ = (\inst1|v_count[9]~0_combout\ & (\inst1|process_0~13_combout\ & ((\inst1|Add1~6_combout\)))) # (!\inst1|v_count[9]~0_combout\ & (((\inst1|v_count\(3)))))
